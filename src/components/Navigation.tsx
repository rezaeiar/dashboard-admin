            ...
            <div className="">
                <ul className='flex flex-col gap-y-1'>
                    <li className='relative before:bg-primary-100 before:h-full before:w-1 before:rounded-e'>
                        <div className="h-10 px-4 mx-4 rounded text-sm flex justify-between items-center text-general-80 hover:bg-primary-60 hover:text-white transition-colors cursor-pointer">
                    ...
                    <li className='relative before:bg-primary-100 before:h-full before:w-1 before:rounded-e before:absolute'>
                        <div className="h-10 px-4 mx-4 rounded text-sm flex justify-between items-center bg-primary-100 text-white hover:bg-primary-60 hover:text-white transition-colors cursor-pointer">
                            <div className="flex gap-x-4 items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 0 0-1.883 2.542l.857 6a2.25 2.25 0 0 0 2.227 1.932H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-1.883-2.542m-16.5 0V6A2.25 2.25 0 0 1 6 3.75h3.879a1.5 1.5 0 0 1 1.06.44l2.122 2.12a1.5 1.5 0 0 0 1.06.44H18A2.25 2.25 0 0 1 20.25 9v.776" />
                                </svg>
