                ...
                <ul className='flex flex-col gap-y-1'>
                    <li className='relative'>
                        <NavLink to={'/'} className={({ isActive }) => {
                            return `h-10 px-4 mx-4 rounded text-sm flex justify-between items-center transition-colors cursor-pointer ${isActive ? 'bg-primary-100 text-white before:bg-primary-100 before:h-full before:w-1 before:rounded-e before:left-0 before:absolute' : 'text-general-80 hover:bg-primary-100 hover:text-white'}`
                        }}>
