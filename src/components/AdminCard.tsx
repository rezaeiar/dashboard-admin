...
const AdminCard = (props: AdminCardProps) => {
    ...
    return (
        <div className={`${props.show ? 'visible opacity-100' : 'invisible opacity-0'} flex transition-all flex-col min-w-48 bg-white shadow-box rounded-xl absolute top-12 rtl:left-0 ltr:right-0 divide-y child-hover:bg-general-30 border border-general-30 overflow-hidden capitalize`}>
