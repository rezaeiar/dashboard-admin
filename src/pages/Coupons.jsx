        ...
        <div className="py-8 px-10 w-full bg-general-30 flex flex-col gap-y-8">
            ...
            <table className='border divide-y border-general-50 bg-white rounded-md w-full flex flex-col overflow-hidden'>
                <tr className='p-4 bg-general-30 grid grid-cols-6 text-sm font-nunitosans-extrabold text-general-100 child:text-start'>
                    <th className='col-span-2'>Coupon Name</th>
                    <th>Usage</th>
                    <th>Status</th>
                    <th>Date</th>
                    <th>Actions</th>
                ...
                <tr className='p-4 bg-white grid grid-cols-6 text-sm text-general-90 child:line-clamp-1 child:h-min items-center child:text-start'>
                    <td className='overflow-hidden col-span-2 flex'>
                        <div className="flex items-center gap-x-4">
                            <div className="h-14 w-14 rounded-md bg-primary-100 flex justify-center items-center text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <div className="flex flex-col text-sm">
                                <h4 className='font-nunitosans-bold text-general-100'>
                                    Summer discount 10% off
                                </h4>
                                <span className='text-general-60'>
                                    Summer2020
                                </span>
                            </div>
                        </div>
