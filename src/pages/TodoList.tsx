                    ...
                    <div className="flex flex-col gap-y-2">
                        {
                            !!userTasksData && userTasksData.map((task: any) => (
                                <div key={task.id} className={`transition-all flex justify-between py-5 rounded-lg border border-general-50 px-6 ${task.isComplated ? "bg-primary-80 text-white" : "bg-white/80 text-general-100"}`}>
                                    <div className="flex gap-x-2 items-center">
                                        ...
                                        <h3 className="font-iransans-semiBold text-sm">
                                            {task.title}
                                        </h3>
                                    </div>
                                    <div className="flex gap-x-2 items-center">
                                        <div className={`p-2 w-12 rounded cursor-pointer border border-general-40 hover:border-red-101 flex items-center justify-center group hover:bg-red-101 transition-all ${task.isComplated ? "bg-primary-40 border-primary-40" : "bg-general-30"}`} onClick={() => showDeleteConfirmModal(task.id)}>
