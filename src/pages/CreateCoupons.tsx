            ...
            <div className="bg-white rounded-md p-5 xl:p-7 col-span-5 flex flex-col gap-y-6 xl:gap-y-8 divide-y">
                <div className="flex flex-col gap-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                        <div className="flex flex-col">
                            ...
                            <input type="text" className="border border-general-50 outline-none rounded text-xs lg:text-sm text-general-100 py-2 md:py-1.5 lg:py-2 px-4 md:px-2.5 lg:px-4" placeholder="Shipfree20" />
                        </div>
                        <div className="flex flex-col">
                            <label htmlFor="" className="text-xs lg:text-sm text-general-60 font-nunitosans-regular">
                                Coupon Name
                            </label>
                            <input type="text" className="border border-general-50 outline-none rounded text-xs lg:text-sm text-general-100 py-2 md:py-1.5 lg:py-2 px-4 md:px-2.5 lg:px-4" placeholder="Free Shipping" />
                        </div>
                    </div>
                </div>
                <div className="flex flex-col gap-y-6 pt-4 xl:pt-6">
                    ...
                    <div className="grid grid-cols-4 gap-x-6">
                        <div className="flex justify-center items-center flex-col py-6 border-2 border-primary-100 hover:border-primary-100 rounded-lg gap-y-3 group cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-primary-100 group-hover:text-primary-100">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                            </svg>
                            <span className="text-primary-100 group-hover:text-primary-100 font-nunitosans-regular">
                                Fixed Discount
                            </span>
                        </div>
                        <div className="flex justify-center items-center flex-col py-6 border-2 border-general-60 hover:border-primary-100 rounded-lg gap-y-3 group transition-all cursor-pointer">
                            ...
                            <span className="text-general-60 group-hover:text-primary-100 font-nunitosans-regular transition-all">
                                Percentage Discount
                            </span>
                        </div>
                        <div className="flex justify-center items-center flex-col py-6 border-2 border-general-60 hover:border-primary-100 rounded-lg gap-y-3 group transition-all cursor-pointer">
